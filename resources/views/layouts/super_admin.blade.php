    ...
    <div class="page-container" style="background-color:#ffffff">
        ...
        <div class="page-sidebar">
            ...
            <ul class="x-navigation">
                ...
                <li>
                    <a href="{{route('super.admin.dash')}}"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>
                </li>
                ...
                <li class="xn-openable">
                    <a href="#"><span class="fa fa-group"></span> <span class="xn-text">Department</span></a>
                    <ul>
                        <li><a href="{{route('department.create')}}"><span class="fa fa-plus"></span>Create Department</a></li>
                        <li><a href="{{route('department.index')}}"><span class="fa fa-list"></span>Department List</a></li>
                    </ul>
                </li>

                <li class="xn-openable">
                    <a href="#"><span class="fa fa-group"></span> <span class="xn-text">Exam Season</span></a>
                    <ul>
                        <li><a href="{{route('exam-season.create')}}"><span class="fa fa-plus"></span>Create Exam Season</a></li>
                        <li><a href="{{route('exam-season.index')}}"><span class="fa fa-list"></span>Exam Season List</a></li>
                    </ul>
                </li>

                <li class="xn-openable">
                    <a href="#"><span class="fa fa-group"></span> <span class="xn-text">Exam Room</span></a>
                    <ul>
                        <li><a href="{{route('exam-room.create')}}"><span class="fa fa-plus"></span>Create Exam Room</a></li>
                        <li><a href="{{route('exam-room.index')}}"><span class="fa fa-list"></span>Exam Room List</a></li>
                    </ul>
                </li>
